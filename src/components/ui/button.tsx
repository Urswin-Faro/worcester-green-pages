  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-base font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        // Custom Cannabis Café variants
        cta: "gradient-cta text-primary-foreground shadow-glow hover:opacity-90 font-semibold",
        hero: "bg-cream text-charcoal hover:bg-cream/90 shadow-card font-semibold",
        whatsapp: "bg-[hsl(142,70%,45%)] text-primary-foreground hover:bg-[hsl(142,70%,40%)] shadow-soft font-semibold",
        call: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-soft font-semibold",
      },
      size: {
